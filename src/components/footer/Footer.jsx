        ...
        <footer className={`${theme === "dark" ? 'bg-slate-900 text-slate-50' : 'bg-slate-300 text-slate-900'} py-8`}>
          <div className="container mx-auto text-center">
            <div className="flex justify-center mb-8 space-x-10">
              <a href="https://github.com/seriie" target="_blank" className={`${theme === "dark" ? 'text-slate-400 hover:text-slate-300' : 'text-slate-700 hover:text-slate-900'}`}>
                <i className="fab fa-github"></i> GitHub
              </a>
              <a href="https://www.linkedin.com/in/mohammad-zidane-rahadian-0b2815290/" target="_blank" className={`${theme === "dark" ? 'text-slate-400 hover:text-slate-300' : 'text-slate-700 hover:text-slate-900'}`}>
                <i className="fab fa-linkedin"></i> LinkedIn
              </a>
              <a href="https://www.instagram.com/zzzeeee05" target="_blank" className={`${theme === "dark" ? 'text-slate-400 hover:text-slate-300' : 'text-slate-700 hover:text-slate-900'}`}>
